...
export const celebrityGroups: MBTICelebrityGroup[] = [
  {
    ...
    celebrities: [
      ...
      },
      {
        ...
        mbtiTraits: ["전략적 사고", "독립성", "분석력", "장기적 비전"],
  ...
  },
  {
    ...
    celebrities: [
      ...
      },
      {
        ...
        mbtiTraits: ["창의적 실험", "데이터 분석", "시스템 최적화", "비전"],
  ...
  },
  {
    ...
    celebrities: [
      ...
      },
      {
        ...
        mbtiTraits: ["카리스마", "리더십", "완벽주의", "전략적 사고"],
        successFactors: ["묘한 매력", "패션 센스", "묵묵한 추진력", "글로벌 아이콘"]
      },
      {
        name: "킴 카다시안",
      ...
      },
{
      ...
      },
      {
        ...
        mbtiTraits: ["전략적 리더십", "철학적 사고", "언어적 재능", "장기적 비전"],
  ...
  },
  {
    ...
    celebrities: [
      ...
      },
      {
        ...
        mbtiTraits: ["분석적 사고", "완벽주의", "논리적 접근", "호기심"],
  ...
  },
  {
    ...
    celebrities: [
      ...
      },
      {
        ...
        description: "BLACKPINK 멤버. 패션 아이콘이자 솔로 아티스트로서 글로벌 영향력",
        achievements: ["BLACKPINK 글로벌 성공", "Chanel 글로벌 앰버서더", "솔로 싱글 'SOLO'"],
        mbtiTraits: ["독창적 표현", "예술 감수성", "실용적 사고", "진정성"],
        successFactors: ["묘한 매력", "패션 센스", "묵묵한 추진력", "글로벌 아이콘"]
      },
      {
        name: "지민",
        ...
        mbtiTraits: ["감정 표현", "헌신", "완벽주의", "진정성"],
        successFactors: ["춤 실력", "묘한 매력", "팬과의 소통", "예술적 성장"]
      },
      {
        name: "올리비아 로드리고",
  ...
  },
  {
    ...
    celebrities: [
      ...
      },
      {
        ...
        mbtiTraits: ["책임감", "완벽주의", "신중함", "체계적"],
        successFactors: ["리더십", "묘한 춤선", "비주얼", "성실함"]
      },
      {
        name: "페이커",
        nameEn: "Faker",
      ...
      },
      {
        ...
        field: "entertainment",
        country: "US",
        description: "YouTuber. 기네스북에 오른 세계 최대 구독자 수 콘텐츠 크리에이터",
        achievements: ["3억 구독자 돌파", "수백만 달러 기부", "제목 최적화 시스템"],
        mbtiTraits: ["체계적", "데이터 분석", "완벽주의", "장기적 관점"],
        successFactors: ["썸네일/제목 최적화", "대규모 프로덕션", "시청자 분석", "꾸준함"]
      }
    ]
  },
  {
    ...
    celebrities: [
      ...
      },
      {
        ...
        field: "entertainment",
        country: "KR",
        description: "aespa 멤버. 뛰어난 가창력과 성실함으로 사랑받는 아이돌",
        achievements: ["솔로 곡 'Spark'", "OST 참여", "글로벌 팬덤"],
        mbtiTraits: ["헌신", "성실함", "배려", "완벽주의"],
        successFactors: ["꾸준한 실력 향상", "팬 서비스", "팀워크", "진정성"]
      },
      {
        name: "손흥민",
  ...
  },
  {
    ...
    celebrities: [
      ...
      },
      {
        ...
        mbtiTraits: ["실용적", "기술 숙달", "즉흥성", "적응력"],
        successFactors: ["춤 실력", "묘한 카리스마", "패션 센스", "묵묵한 노력"]
      },
      {
        name: "다니엘",
        nameEn: "Danielle",
