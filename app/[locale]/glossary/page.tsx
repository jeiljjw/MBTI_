...
const glossaryTermsKo = [
  // 기본 개념
  {
    ...
    definition: "심리학자卡尔 융의 심리 유형론을 기반으로 캐서린 브릭스와 이사벨 마이어스가 개발한 성격 유형 검사 도구입니다. 사람들의 성격을 16가지 유형으로 분류하여 각 유형의 특징과 행동 패턴을 설명합니다.",
    category: "기본 개념"
  },
  {
  ...
  {
    term: "융의 심리 유형론",
    definition: "MBTI의 기초가 되는 이론으로,卡尔 융이 제시한 심리적 기능과 태도의 개념입니다. 인식 기능(감각/직관)과 판단 기능(사고/감정), 그리고 태도(외향/내향)를 기반으로 합니다.",
    category: "역사 및 이론"
  },
  ...
  {
    term: "루프(Loop)",
    definition: "스트레스 상황에서 주功能和열등기능만을 반복적으로 사용할 때 발생하는 부정적인 상태입니다. 균형 잡힌 사고가 어려워집니다.",
    category: "심화 개념"
  },
  {
    term: "그립(Grip)",
  ...
  {
    term: "MBTI의 역사",
    definition: "1920년대卡尔 융의 심리 유형론을 기반으로 1940년대 Isabel Briggs Myers와 Katharine Cook Briggs가 개발했습니다. 1962년 상업화되었으며, 현재 전 세계적으로 널리 사용되는 성격 검사입니다.",
    category: "역사 및 발전"
  },
  {
    term: "신뢰도와 타당도",
