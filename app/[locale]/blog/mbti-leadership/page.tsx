...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = isEn
    ? "MBTI Leadership Styles: Communication and Influence by Type | MBTI Blog"
    : "MBTI로 보는 리더십 스타일: 유형별 소통과 영향력 | MBTI 블로그";
  const description = isEn
    ? "How each of the 16 MBTI types leads and communicates. Type-specific strategies to lead teams effectively."
    : "16가지 MBTI 유형별로 다른 리더십 스타일과 소통 방식을 분석합니다. 팀을 효과적으로 이끌기 위한 유형별 맞춤 전략을 알아봅니다.";
  return {
    title,
    description,
    keywords: isEn
      ? ["MBTI leadership", "leadership style", "MBTI type leadership", "team leadership", "communication"]
      : ["MBTI 리더십", "리더십 스타일", "MBTI 유형별 리더십", "팀 리더십", "소통 방식"],
    openGraph: { title, description, type: "article" },
  };
}

function LeadershipKo({ t }: { t: (key: string) => string }) {
  return (
    <>
      ...
      <header className="mb-10">
        ...
        <p className="text-xl text-gray-400 leading-relaxed">
          리더십은 한 가지 방식으로만 작동하지 않습니다. MBTI 성격 유형에 따라 리더십 스타일, 소통 방식, 팀 관리 접근법이 크게 달라집니다. 각 유형의 강점을 살린 효과적인 리더십 전략을 알아봅니다.
        </p>
      </header>
      ...
      <div className="border-t border-gray-800 pt-6 mb-10">
        <div className="flex items-center justify-between text-sm text-gray-500">
          <span>{t("writtenOn")}: 2026년 2월 18일</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Link href="/blog/intj-career-strategies" className="group">
            <div className="bg-black/20 backdrop-blur-md rounded-lg p-4 border border-white/10 hover:border-blue-400 transition-all">
              <h4 className="font-semibold text-white group-hover:text-blue-400 mb-1">INTJ가 알아야 할 10가지 커리어 전략</h4>
          ...
          <Link href="/blog/mbti-career-correlation" className="group">
            <div className="bg-black/20 backdrop-blur-md rounded-lg p-4 border border-white/10 hover:border-pink-400 transition-all">
              <h4 className="font-semibold text-white group-hover:text-pink-400 mb-1">MBTI와 진로 적성의 상관관계</h4>
...
function LeadershipEn({ t }: { t: (key: string) => string }) {
  return (
    <>
      <nav className="text-sm text-gray-400 mb-6">
        <ol className="flex items-center space-x-2">
          ...
          <li><Link href="/blog" className="hover:text-white transition-colors">{t("blog")}</Link></li>
          <li>&gt;</li>
          <li className="text-white">MBTI Leadership Styles</li>
        </ol>
      </nav>
      <header className="mb-10">
        <div className="flex items-center gap-3 mb-4">
      ...
      <div className="bg-black/20 backdrop-blur-md rounded-xl p-6 border border-white/10 mb-10">
        <h2 className="text-lg font-bold text-white mb-4">{t("tocTitle")}</h2>
        <ul className="space-y-2 text-gray-400">
          <li><a href="#overview" className="hover:text-white transition-colors">1. Leadership and MBTI</a></li>
          <li><a href="#analysts" className="hover:text-white transition-colors">2. Analysts (NT)</a></li>
          <li><a href="#diplomats" className="hover:text-white transition-colors">3. Diplomats (NF)</a></li>
          <li><a href="#sentinels" className="hover:text-white transition-colors">4. Sentinels (SJ)</a></li>
          <li><a href="#explorers" className="hover:text-white transition-colors">5. Explorers (SP)</a></li>
          <li><a href="#communication" className="hover:text-white transition-colors">6. Communication by Type</a></li>
          <li><a href="#tips" className="hover:text-white transition-colors">7. Tips for Effective Leadership</a></li>
        </ul>
      </div>
      <div className="prose prose-invert prose-lg max-w-none">
        <section id="overview" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">1. Leadership and MBTI</h2>
          <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <div className="bg-blue-900/20 border-l-4 border-blue-500 p-4 my-6">
            <p className="text-blue-200 text-sm"><strong>Key point:</strong> Every MBTI type can lead. What matters is developing a style that fits your type and respecting team diversity.</p>
          </div>
        </section>
        <section id="analysts" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">2. Analysts (NT): Strategic Leaders</h2>
          <p className="text-gray-300 leading-relaxed mb-4">
        ...
        <section id="diplomats" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">3. Diplomats (NF): Visionaries</h2>
          <p className="text-gray-300 leading-relaxed mb-4">
        ...
        <section id="sentinels" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">4. Sentinels (SJ): Steady Leaders</h2>
          <p className="text-gray-300 leading-relaxed mb-4">
        ...
        <section id="explorers" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">5. Explorers (SP): Innovative Leaders</h2>
          <p className="text-gray-300 leading-relaxed mb-4">
        ...
        <section id="communication" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">6. Communication by Type</h2>
          <p className="text-gray-300 leading-relaxed mb-4">
        ...
        <section id="tips" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">7. Tips for Effective Leadership</h2>
          <p className="text-gray-300 leading-relaxed mb-4">
      ...
      <div className="border-t border-gray-800 pt-6 mb-10">
        <div className="flex items-center justify-between text-sm text-gray-500">
          <span>{t("writtenOn")}: February 18, 2026</span>
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Link href="/blog/mbti-career-correlation" className="group">
            <div className="bg-black/20 backdrop-blur-md rounded-lg p-4 border border-white/10 hover:border-pink-400 transition-all">
              <h4 className="font-semibold text-white group-hover:text-pink-400 mb-1">MBTI and Career Correlation</h4>
  ...
  return (
    <div className="min-h-screen bg-neutral-950 pt-24 pb-16">
      <article className="max-w-4xl mx-auto px-4">
        {isEn ? <LeadershipEn t={t} /> : <LeadershipKo t={t} />}
      </article>
    </div>
  );
}
