...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = isEn
    ? "MBTI Learning Styles: How Each Type Learns Best | MBTI Blog"
    : "MBTI 학습 스타일: 유형별로 가장 효과적인 공부법 | MBTI 블로그";
  const description = isEn
    ? "Effective learning methods for all 16 MBTI types. Custom study strategies and learning tips by type."
    : "16가지 MBTI 유형별로 가장 효과적인 학습 방법을 분석합니다. 각 유형의 장점을 살린 맞춤형 공부 전략과 학습 도우니를 알아봅니다.";
  return {
    title,
    description,
    keywords: isEn
      ? ["MBTI learning", "learning styles", "study by type", "MBTI education", "effective study"]
      : ["MBTI 학습", "유형별 공부법", "학습 스타일", "MBTI 교육", "효과적인 공부"],
    openGraph: { title, description, type: "article" },
  };
}

function LearningStylesKo({ t }: { t: (key: string) => string }) {
  return (
    <>
...
function LearningStylesEn({ t }: { t: (key: string) => string }) {
  return (
    <>
      <nav className="text-sm text-gray-400 mb-6">
        <ol className="flex items-center space-x-2">
          ...
          <li><Link href="/blog" className="hover:text-white transition-colors">{t("blog")}</Link></li>
          <li>&gt;</li>
          <li className="text-white">MBTI Learning Styles</li>
        </ol>
      </nav>
      <header className="mb-10">
        <div className="flex items-center gap-3 mb-4">
      ...
      <div className="bg-black/20 backdrop-blur-md rounded-xl p-6 border border-white/10 mb-10">
        <h2 className="text-lg font-bold text-white mb-4">{t("tocTitle")}</h2>
        <ul className="space-y-2 text-gray-400">
          <li><a href="#learning-basics" className="hover:text-white transition-colors">1. Learning and MBTI Basics</a></li>
          <li><a href="#nt-learners" className="hover:text-white transition-colors">2. Analysts (NT)</a></li>
          <li><a href="#nf-learners" className="hover:text-white transition-colors">3. Diplomats (NF)</a></li>
          <li><a href="#sj-learners" className="hover:text-white transition-colors">4. Sentinels (SJ)</a></li>
          <li><a href="#sp-learners" className="hover:text-white transition-colors">5. Explorers (SP)</a></li>
          <li><a href="#study-tips" className="hover:text-white transition-colors">6. Study Tips by Type</a></li>
          <li><a href="#optimal-environment" className="hover:text-white transition-colors">7. Optimal Learning Environment</a></li>
        </ul>
      </div>
      <div className="prose prose-invert prose-lg max-w-none">
        <section id="learning-basics" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">1. Learning and MBTI Basics</h2>
          <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <div className="bg-blue-900/20 border-l-4 border-blue-500 p-4 my-6">
            <p className="text-blue-200 text-sm"><strong>Key point:</strong> Knowing your learning style helps you study more efficiently and build on strengths.</p>
          </div>
        </section>
        <section id="nt-learners" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">2. Analyst Types (NT)</h2>
          <p className="text-gray-300 leading-relaxed mb-4">Analysts like intellectual challenge and depth. INTJ: self-directed, systems thinking, project-based. INTP: curiosity-driven, discussion and research. ENTJ: clear goals, structured plans. ENTP: debate, variety, hands-on. Use online courses, puzzles, and strategy games.</p>
        </section>
        <section id="nf-learners" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">3. Diplomat Types (NF)</h2>
          <p className="text-gray-300 leading-relaxed mb-4">Diplomats learn through meaning and connection. INFJ: big picture, reflection, writing. INFP: personal relevance, creativity, discussion. ENFJ: teaching others, group work. ENFP: variety, projects, collaboration. Use stories, discussion, and meaningful applications.</p>
        </section>
        <section id="sj-learners" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">4. Sentinel Types (SJ)</h2>
          <p className="text-gray-300 leading-relaxed mb-4">Sentinels prefer structure and practical use. ISTJ: step-by-step, routines, clear goals. ISFJ: detail, helping others, practice. ESTJ: organization, deadlines, real-world use. ESFJ: group study, application to people. Use outlines, schedules, and concrete examples.</p>
        </section>
        <section id="sp-learners" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">5. Explorer Types (SP)</h2>
          <p className="text-gray-300 leading-relaxed mb-4">Explorers learn by doing and experimenting. ISTP: hands-on, troubleshooting. ISFP: creative, sensory, flexible. ESTP: action, competition, quick practice. ESFP: social learning, games, variety. Use simulations, labs, and interactive tools.</p>
        </section>
        <section id="study-tips" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">6. Study Tips by Type</h2>
          <p className="text-gray-300 leading-relaxed mb-4">E types: try quiet focus sometimes. I types: try study groups sometimes. N: check facts; S: keep the big picture. T: consider emotional meaning; F: use objective criteria. J: add flexibility; P: add some structure.</p>
        </section>
        <section id="optimal-environment" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">7. Optimal Learning Environment</h2>
          <p className="text-gray-300 leading-relaxed mb-4">I types often prefer quiet, solo space; E types may prefer cafes or study groups. J types like clear plans; P types like flexibility. N types may prefer digital tools; S types concrete materials. Choose what fits your type and mix when helpful.</p>
        </section>
      </div>
      <div className="border-t border-gray-800 pt-6 mb-10">
        <div className="flex items-center justify-between text-sm text-gray-500">
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Link href="/blog/mbti-career-correlation" className="group">
            <div className="bg-black/20 backdrop-blur-md rounded-lg p-4 border border-white/10 hover:border-purple-400 transition-all">
              <h4 className="font-semibold text-white group-hover:text-purple-400 mb-1">MBTI and Career Correlation</h4>
  ...
  return (
    <div className="min-h-screen bg-neutral-950 pt-24 pb-16">
      <article className="max-w-4xl mx-auto px-4">
        {isEn ? <LearningStylesEn t={t} /> : <LearningStylesKo t={t} />}
      </article>
    </div>
  );
}
