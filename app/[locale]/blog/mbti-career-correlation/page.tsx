...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = isEn
    ...
    : "MBTI와 진로 적성의 상관관계: 통계로 증명되는 커리어 적합도 | MBTI 블로그";
  const description = isEn
    ...
    : "MBTI 유형과 직업 만족도, 성과, 이직률 간의 상관관계를 데이터로 분석합니다. 어떤 유형이 어떤 직업에서 성공하는지 연구 결과를 소개합니다.";
  return {
    title,
    description,
    keywords: isEn
      ? ["MBTI career", "MBTI job", "personality career", "MBTI statistics", "career fit", "job satisfaction"]
      : ["MBTI 직업", "MBTI 진로", "성격 유형 직업", "MBTI 통계", "커리어 적성", "직업 만족도"],
    ...
    <>
      ...
      <header className="mb-10">
        ...
        <p className="text-xl text-gray-400 leading-relaxed">
          통계 데이터로 분석하는 MBTI 유형별 직업 적합도. 어떤 유형이 어떤 직업에서 성공하는지 과학적 근거를 바탕으로 알아봅니다.
        </p>
      </header>
      <div className="bg-black/20 backdrop-blur-md rounded-xl p-6 border border-white/10 mb-10">
        ...
        <ul className="space-y-2 text-gray-400">
          <li><a href="#overview" className="hover:text-white transition-colors">1. MBTI는 직업 성공을 예측할 수 있을까?</a></li>
          <li><a href="#satisfaction" className="hover:text-white transition-colors">2. 직업 만족도와 MBTI</a></li>
          <li><a href="#distribution" className="hover:text-white transition-colors">3. 유형별 직업 분포 및 성과</a></li>
          <li><a href="#turnover" className="hover:text-white transition-colors">4. MBTI와 이직률</a></li>
          <li><a href="#by-job" className="hover:text-white transition-colors">5. 직업별 최적/최악의 유형</a></li>
          <li><a href="#limits" className="hover:text-white transition-colors">6. MBTI의 한계와 주의사항</a></li>
          <li><a href="#practical" className="hover:text-white transition-colors">7. 실용적인 커리어 조언</a></li>
          <li><a href="#conclusion" className="hover:text-white transition-colors">8. 결론</a></li>
        </ul>
      </div>
    ...
    <>
      ...
      <div className="prose prose-invert prose-lg max-w-none">
        ...
        <section id="satisfaction" className="mb-12">
          ...
          <h3 className="text-xl font-bold text-white mb-3">1.2 Job–Type Fit Research</h3>
          <p className="text-gray-300 leading-relaxed mb-4">
        ...
        <section id="conclusion" className="mb-12">
          ...
          <p className="text-gray-300 leading-relaxed mb-4">
            Statistically, MBTI has a weak correlation with career success. Some types are overrepresented in some jobs, but that may reflect bias. <strong>Any type can succeed in any career.</strong> Use MBTI to understand your preferences and challenges—not as the only factor in career choice.
          </p>
          <div className="bg-green-900/20 border-l-4 border-green-500 p-4 my-6">
