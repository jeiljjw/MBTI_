...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = isEn
    ? "MBTI Love and Relationships: Dating Patterns and Bonding by Type | MBTI Blog"
    : "MBTI 사랑과 관계: 유형별 연애 패턴과 관계 구축법 | MBTI 블로그";
  const description = isEn
    ? "How each of the 16 MBTI types loves and relates. Dating styles, love languages, and building deeper bonds by type."
    : "16가지 MBTI 유형별 연애 스타일과 사랑의 표현 방식을 분석합니다. 각 유형이 관계에서 어떻게 행동하는지, 더 깊은 유대를 형성하는 방법을 알아봅니다.";
  return {
    title,
    description,
    keywords: isEn
      ? ["MBTI love", "dating by type", "MBTI relationship", "love language", "relationship building"]
      : ["MBTI 연애", "유형별 연애 스타일", "MBTI 사랑", "관계 구축", "연애 패턴"],
    openGraph: { title, description, type: "article" },
  };
}

function LoveKo({ t }: { t: (key: string) => string }) {
  return (
    <>
      ...
      <header className="mb-10">
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-gray-500 text-sm">11분 {t("readTime")}</span>
        </div>
        ...
        <p className="text-xl text-gray-400 leading-relaxed">
          사랑은 모든 사람의 욕구이지만, 표현하고 경험하는 방식은 제각기 다릅니다. MBTI 유형이 연애 스타일, 사랑의 언어, 관계에서의 필요에 어떻게 영향을 미치는지 알아봅니다.
        </p>
      </header>
...
function LoveRelationshipsEn({ t }: { t: (key: string) => string }) {
  return (
    <>
      <nav className="text-sm text-gray-400 mb-6">
        <ol className="flex items-center space-x-2">
          ...
          <li><Link href="/blog" className="hover:text-white transition-colors">{t("blog")}</Link></li>
          <li>&gt;</li>
          <li className="text-white">MBTI Love and Relationships</li>
        </ol>
      </nav>
      <header className="mb-10">
        <div className="flex items-center gap-3 mb-4">
      ...
      <div className="bg-black/20 backdrop-blur-md rounded-xl p-6 border border-white/10 mb-10">
        <h2 className="text-lg font-bold text-white mb-4">{t("tocTitle")}</h2>
        <ul className="space-y-2 text-gray-400">
          <li><a href="#understanding-love" className="hover:text-white transition-colors">1. Love and MBTI</a></li>
          <li><a href="#nt-types" className="hover:text-white transition-colors">2. Analysts (NT)</a></li>
          <li><a href="#nf-types" className="hover:text-white transition-colors">3. Diplomats (NF)</a></li>
          <li><a href="#sj-types" className="hover:text-white transition-colors">4. Sentinels (SJ)</a></li>
          <li><a href="#sp-types" className="hover:text-white transition-colors">5. Explorers (SP)</a></li>
          <li><a href="#love-language" className="hover:text-white transition-colors">6. Love Languages by Type</a></li>
          <li><a href="#building-bonds" className="hover:text-white transition-colors">7. Building Deeper Bonds</a></li>
        </ul>
      </div>
      <div className="prose prose-invert prose-lg max-w-none">
        <section id="understanding-love" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">1. Love and MBTI</h2>
          <p className="text-gray-300 leading-relaxed mb-4">How we love, what we need in relationships, and how we behave with partners are tied to personality. MBTI describes how each type experiences relationship through E/I, S/N, T/F, and J/P. No type is &quot;best&quot; at love; what matters is understanding yourself and your partner and respecting differences.</p>
        </section>
        <section id="nt-types" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">2. Analyst Types (NT)</h2>
          <p className="text-gray-300 leading-relaxed mb-4">INTJ: Strategic, loyal; may struggle to express feelings. INTP: Idealistic, analytical; values autonomy and deep conversation. ENTJ: Direct, goal-oriented; can seem dominant. ENTP: Enthusiastic, debate-loving; needs variety. Love languages: acts of service, intellectual connection, respect.</p>
        </section>
        <section id="nf-types" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">3. Diplomat Types (NF)</h2>
          <p className="text-gray-300 leading-relaxed mb-4">INFJ: Deep commitment, need for meaning; may neglect self. INFP: Idealistic, sensitive; values authenticity. ENFJ: Caring, supportive; may over-give. ENFP: Passionate, playful; needs connection and novelty. Love languages: quality time, words of affirmation, emotional depth.</p>
        </section>
        <section id="sj-types" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">4. Sentinel Types (SJ)</h2>
          <p className="text-gray-300 leading-relaxed mb-4">ISTJ: Reliable, loyal; shows love through action. ISFJ: Nurturing, devoted; values harmony. ESTJ: Protective, practical; direct communication. ESFJ: Warm, attentive; needs appreciation. Love languages: acts of service, quality time, tangible support.</p>
        </section>
        <section id="sp-types" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">5. Explorer Types (SP)</h2>
          <p className="text-gray-300 leading-relaxed mb-4">ISTP: Independent, action-oriented; may seem distant. ISFP: Gentle, artistic; values beauty and harmony. ESTP: Energetic, fun-loving; lives in the moment. ESFP: Affectionate, social; needs excitement and connection. Love languages: physical touch, quality time, shared experiences.</p>
        </section>
        <section id="love-language" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">6. Love Languages by Type</h2>
          <p className="text-gray-300 leading-relaxed mb-4">T types often value acts of service and respect; F types quality time and words of affirmation. S types may prefer tangible gestures; N types symbolic or verbal expression. Learn your and your partner&apos;s languages to show love in ways that land.</p>
        </section>
        <section id="building-bonds" className="mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">7. Building Deeper Bonds</h2>
          <p className="text-gray-300 leading-relaxed mb-4">Communicate openly, listen without judging, respect each other&apos;s need for space (I) or connection (E), and support each other&apos;s growth. MBTI is a tool for self-understanding; use it to become a better partner.</p>
        </section>
      </div>
      <div className="border-t border-gray-800 pt-6 mb-10">
        <div className="flex items-center justify-between text-sm text-gray-500">
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Link href="/blog/stress-management-by-type" className="group">
            <div className="bg-black/20 backdrop-blur-md rounded-lg p-4 border border-white/10 hover:border-green-400 transition-all">
              <h4 className="font-semibold text-white group-hover:text-green-400 mb-1">Stress Management by Type</h4>
  ...
  return (
    <div className="min-h-screen bg-neutral-950 pt-24 pb-16">
      <article className="max-w-4xl mx-auto px-4">
        {isEn ? <LoveRelationshipsEn t={t} /> : <LoveKo t={t} />}
      </article>
    </div>
  );
}
