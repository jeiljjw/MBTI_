...
export const metadata: Metadata = {
  title: "감정지능(EQ)과 MBTI의 상관관계: 정서적 성장을 위한 안내 | MBTI 블로그",
  description: "감정지능과 MBTI는 어떻게 연결될까요? 각 유형의 감정적 특성과 EQ를 높이는 방법을 과학적 관점에서 분석합니다.",
  keywords: ["감정지능", "EQ", "MBTI", "정서적 지능", "감정 관리", "MBTI 감정"],
  openGraph: {
    title: "감정지능(EQ)과 MBTI의 상관관계: 정서적 성장을 위한 안내",
    description: "각 MBTI 유형의 감정적 특성과 감정지능을 높이는 방법을 알아보세요.",
    type: "article",
  },
};
